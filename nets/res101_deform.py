#!/usr/bin/env python
# @Time    : 23/8/18 4:47 PM
# @Author  : Huaizheng Zhang
# @Site    : zhanghuaizheng.info
# @File    : res101_deform.py
...
from nets.faster_rcnn_deform_res101 import _fasterRCNN
...
class resnet(_fasterRCNN):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
        self.model_path = 'models/pretrained_models/resnet101_caffe.pth'
    ...
    def _init_modules(self):
        ...
        #
        # TODO Revise top based on the deform paper (original is 2048, now is 1024)
        ...
        # self.RCNN_top_deform(set_bn_fix)
    ...
    def train(self, mode=True):
        ...
        if mode:
            ...
            # self.RCNN_top_deform(set_bn_eval)
